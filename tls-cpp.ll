...
@.str.1 = private unnamed_addr constant [20 x i8] c": threadLocalVar = \00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_tls.cpp, ptr null }]
...
define dso_local noundef ptr @_Z14threadFunctionPv(ptr noundef %arg) #4 {
entry:
  %arg.addr = alloca ptr, align 8
  store ptr %arg, ptr %arg.addr, align 8
  %0 = load ptr, ptr %arg.addr, align 8
  %1 = load i32, ptr %0, align 4
  %2 = call align 4 ptr @llvm.threadlocal.address.p0(ptr align 4 @threadLocalVar)
  ...
  %5 = call align 4 ptr @llvm.threadlocal.address.p0(ptr align 4 @threadLocalVar)
  %6 = load i32, ptr %5, align 4
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call2, i32 noundef %6)
...
entry:
  ...
  store i32 2, ptr %value2, align 4
  %call = call i32 @pthread_create(ptr noundef %thread1, ptr noundef null, ptr noundef @_Z14threadFunctionPv, ptr noundef %value1) #3
  %call1 = call i32 @pthread_create(ptr noundef %thread2, ptr noundef null, ptr noundef @_Z14threadFunctionPv, ptr noundef %value2) #3
  %0 = load i64, ptr %thread1, align 8
  %call2 = call i32 @pthread_join(i64 noundef %0, ptr noundef null)
  %1 = load i64, ptr %thread2, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_tls.cpp() #0 section ".text.startup" {
entry:
